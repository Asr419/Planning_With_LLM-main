...
from transformers import LlamaForSequenceClassification, LlamaTokenizer, get_linear_schedule_with_warmup
...
if __name__=="__main__":
    wandb.init(project="llama_rl_score_prediction", name="Loss_log")
    ...
    if accelerator.is_main_process:
        ...
        model_save_path = os.path.join('models', 'fine_tuned_llama_score_predictor')
