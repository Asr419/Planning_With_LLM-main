...
log_folder = "hotpot_qa/logs/cot"
if not os.path.exists(log_folder):
    os.makedirs(log_folder)

# Set up logging
# log_file = os.path.join(log_folder, f"cot_{datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}.log")
log_file = os.path.join(log_folder, f"cot_workfront_trial.log")
